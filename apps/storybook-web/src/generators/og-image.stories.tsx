  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1280, margin: '0 auto' }}>
        ...
        >
          Generate branded Open Graph images for Swiss Activities pages.
          Enter a title and optional subtitle, then download as PNG.
        </p>
        ...
        <button
          ...
          style={{
            ...
            fontWeight: 600,
            color: 'white',
            backgroundColor: !svgDataUrl || isGenerating ? grayColors[300] : saColors.primary,
            border: 'none',
            borderRadius: 8,
