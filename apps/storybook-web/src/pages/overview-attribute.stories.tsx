...
import { gatewayOverviewAttributeResponse } from "../fixtures/gateway-overview-attribute-response";
import { GatewayPage, type GatewayPageStoryArgs } from "./gateway-page";

const meta = {
  title: "Pages/Overview - Attribute",
  parameters: { layout: "fullscreen" },
  args: {
    locale: "de_CH",
    page: {
      type: "overview-attribute",
      data: gatewayOverviewAttributeResponse,
      slug: "familien",
    },
  },
