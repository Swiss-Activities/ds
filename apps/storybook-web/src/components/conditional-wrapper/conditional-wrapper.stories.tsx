...
export const WithWrapper: Story = {
  args: {
    ...
    children: <span className="text-sm text-gray-700">This content is wrapped</span>,
  },
}
...
export const WithoutWrapper: Story = {
  args: {
    ...
    children: <span className="text-sm text-gray-700">This content is not wrapped</span>,
  },
}
