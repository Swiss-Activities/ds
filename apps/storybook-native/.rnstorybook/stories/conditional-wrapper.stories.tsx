...
export const WithWrapper: Story = {
  args: {
    ...
    children: <Text style={{ fontSize: 14, color: '#404040' }}>This content is wrapped</Text>,
  },
  render: args => (
...
export const WithoutWrapper: Story = {
  args: {
    ...
    children: <Text style={{ fontSize: 14, color: '#404040' }}>This content is not wrapped</Text>,
  },
  render: args => (
    <View style={{ padding: 16 }}>
      <ConditionalWrapper {...args} />
