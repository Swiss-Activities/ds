export const sharedButtonBaseStyles = {
    container: "group inline-flex h-[max-content] max-h-max min-h-[48px] cursor-pointer appearance-none items-center justify-center rounded-lg border-solid px-3.5 py-2.5 text-center transition duration-100 ease-in",
    text: "text-sm font-medium",
};
export const sharedButtonDisabledStyles = {
    container: "pointer-events-none border-gray-300 bg-gray-300",
};
export const sharedButtonVariantStyles = {
    primary: {
        container: "border border-primary bg-primary",
        text: "text-white",
        webInteraction: "hover:text-white sm:hover:border-dark sm:hover:bg-dark focus-visible:outline-dark",
    },
    secondary: {
        container: "border border-gray-400 bg-white",
        text: "text-gray-700",
        webInteraction: "sm:hover:border-gray-500 sm:hover:bg-gray-500 sm:hover:text-white focus-visible:outline-gray-500",
    },
    tertiary: {
    ...
    outline: {
        ...
        text: "text-primary",
        webInteraction: "sm:hover:bg-primary sm:hover:text-white focus-visible:outline-primary",
    },
    "outline-gray": {
    ...
    transparent: {
        container: "border border-transparent bg-transparent",
        text: "text-black",
        webInteraction: "sm:hover:border-gray-100 sm:hover:bg-gray-100 focus-visible:outline-gray-300",
    },
    "blue-outline": {
        container: "border border-blue bg-transparent",
        text: "text-blue",
        webInteraction: "sm:hover:border-blue sm:hover:bg-blue sm:hover:text-white focus-visible:outline-blue",
    },
    blue: {
    ...
    filter: {
        container: "min-h-[36px] rounded-full border border-gray-200 bg-white px-3 py-1.5 shadow-[0_1px_2px_0_rgba(0,0,0,0.08)]",
        text: "text-gray-700 text-xs sm:text-sm",
        webInteraction: "sm:hover:border-gray-300 sm:hover:bg-gray-50 focus-visible:outline-gray-300",
    },
    instruction: {
    ...
    pill: {
        container: "min-h-[32px] rounded-full border border-blue bg-transparent px-3 py-1.5 lg:min-h-[36px]",
        text: "text-blue text-xs sm:text-sm",
        webInteraction: "lg:hover:bg-blue lg:hover:text-white focus-visible:outline-blue",
    },
    "pill-primary": {
        container: "min-h-[32px] rounded-full border border-primary bg-primary px-3 py-1.5 lg:min-h-[36px]",
...
export const sharedButtonSizeStyles = {
    xs: {
